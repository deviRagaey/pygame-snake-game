...
if check_errors[1] > 0:
    ...
    print("(+)PyGame Saccessfully initialized!")
    
#Play Surface
playSurface = pygame.display.set_mode((720, 460))
pygame.display.set_caption('Snake Game! | Follow Me on Twitter: Dev_iRagaey')
...
brown = pygame.Color(165, 48, 42) #Food
...
while True:
    ...
    #Bound    
    if snakePos[0] > 705 or snakePos[0] < 0:
        gameOver()
